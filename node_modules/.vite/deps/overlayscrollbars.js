...
// node_modules/.pnpm/overlayscrollbars@2.11.4/node_modules/overlayscrollbars/overlayscrollbars.mjs
...
var createDOMObserver = (t2, n2, o2, s2) => {
  ...
  const [d2, p2] = createEventContentChange(t2, _2, i2);
  const v2 = c2 || [];
  const g2 = r2 || [];
...
var createObserversSetup = (t2, n2, o2, s2) => {
  ...
  const { dt: p2, vt: v2, L: g2, gt: h2, ht: b2, V: w2, bt: y2, wt: S2, yt: m2, St: O2 } = t2;
  ...
  const I2 = !w2 && createSizeObserver(v2, onSizeChanged, {
    ft: true
  });
...
var createScrollbarsSetupElements = (t2, n2, o2, s2) => {
  ...
  const { slot: a2 } = l2;
  const { dt: u2, vt: f2, L: _2, At: d2, gt: v2, bt: g2, V: h2 } = n2;
  ...
  const createInteractiveScrollEvents = () => {
    ...
    return addEventListener(h2, "pointerdown", (o3) => {
      ...
      if (x2) {
        ...
        const O4 = e(getBoundingClientRect(d2)[r3]) / I(d2)[a2] || 1;
...
var createScrollbarsSetup = (t2, n2, o2, s2, e2, c2) => {
  ...
  const M2 = [S2, h2, w2, v2, () => f2(), addEventListener($2, "pointerover", onHostMouseEnter, {
    A: true
  ...
  return [() => bind(runEachAndClear, push(M2, O2())), ({ zt: t3, It: n3, Qt: e3, Zt: c3 }) => {
...
var createOverflowUpdateSegment = (t2, s2) => {
  ...
  const [$2, C2] = createCache(y2, bind(D, i2));
  const [z2, T2] = createCache(y2);
  const [I2] = createCache(S2);
  ...
  return ({ zt: n2, Qt: o2, un: l2, It: a3 }, { _n: u3 }) => {
    const { _t: f3, Ht: _3, xt: b3, $t: w3, ft: y3, Et: S3 } = o2 || {};
...
var createSetups = (t2, n2, o2, s2, e2) => {
  ...
  const update = (t3, e3) => {
    ...
    const { pn: r3, It: i3, Tt: a3, vn: u3 } = t3;
    const f3 = r3 || {};
    const _3 = !!i3 || !c2;
    const v3 = {
...
var OverlayScrollbars = (t2, n2, o2) => {
  ...
  if (n2 && !r2) {
    ...
    const [g2, h2, b2, w2, y2] = createSetups(t2, a2, () => r3, ({ pn: t3, It: n3 }, { Qt: o3, Zt: s3 }) => {
      const { _t: e3, $t: c3, Ct: r4, xt: i3, Ht: l3, ft: a3 } = o3;
    ...
    const S2 = {
      ...
      elements() {
        const { dt: t3, vt: n3, rn: o3, L: s3, ht: e3, gt: c3, Kt: r4 } = w2.bn;
        const { jt: i3, Jt: l3 } = w2.wn;
    ...
    if (cancelInitialization(w2.bn.bt, !e2 && t2.cancel)) {
      destroy(true);
      return S2;
    }
    push(i2, g2());
